...
*this third option does not have much utility, but for example, it can be used if you've push-committed with a [skip-ci] and now realize you want to re-render the site to see the updates

To see what the changes you've made to the .qmd files that underpin the site would look like online, use `quarto render` in the Terminal of your IDE
